...
/*   Updated: 2024/09/14 20:18:35 by rosman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap() : ClapTrap() {
    ...
    _energyPoints = 50;
    _attackDamage = 20;
    std::cout << CYAN << YELLOW << "🤖 ScavTrap (DEFAULT Constructor with no name) created! 💚" 
...
void ScavTrap::guardGate() {
    std::string name = (_name.empty()) ? "Defualt Name" : _name;
    std::cout << CYAN << YELLOW << "ScavTrap " << name << " : is now in Gate keeper mode.\n"<< RESET;
}
