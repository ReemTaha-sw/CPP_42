...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/28 21:35:31 by rosman            #+#    #+#             */
/*   Updated: 2024/09/04 13:59:16 by rosman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void addContact(PhoneBook &phoneBook) {
    ...
    while (true) {
        ...
        if (isPhoneNumber(check_phone) && check_phone.length() > 9 && check_phone.length() < 15)
        {
            phone_number = check_phone;
            break;
        } else {
            std::cout << "\033[31mInvalid input\033[0m. Enter Phone Number (+9715.., 055.., 0097155..): ";
        }
    }
